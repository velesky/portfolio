...
Le dossier principal contenant l'application Next.js 15 est **`portfolio-velesky`**.
Vous y trouverez tout le code source, les composants et les ressources du portfolio.

## 🛠️ Stack Technique (Dossier `portfolio-velesky`)
...
1. Clonez le dépôt et naviguez dans le sous-dossier de l'app :
   ```bash
   git clone https://github.com/velesky/portfolio.git
   cd portfolio/portfolio-velesky
   ```
