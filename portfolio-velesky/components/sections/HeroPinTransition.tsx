...
export function HeroPinTransition() {
  ...
  useEffect(() => {
    ...
    // Force le scroll en haut au rafraîchissement (évite le saut sur Mobile)
  ...
  return (
    <>
      ...
      <div ref={pinRootRef} style={{ position: "relative" }}>
        ...
        <div
          ...
          style={{
            ...
            transform: "translateY(100vh)", // Evite le flash (FOUC) avant l'init GSAP
          }}
        >
          <ProjetsSection />
        </div>
