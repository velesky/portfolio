...
import { VELESKY, COULEURS, VIEWPORT_CONFIG } from "@/lib/constants";
...
export function AProposSection() {
    ...
    // Split text pour le titre "QUI EST VELESKY ?"
    const titleText = "QUI EST VELESKY ?";
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-20">
                    ...
                    >
                        ...
                        <span className="font-dm-mono text-xs tracking-[0.3em] uppercase" style={{ color: COULEURS.accent }}>
                            L&apos;identité
                        </span>
                    </motion.div>
                    ...
                    <h2
                        ...
                        style={{ fontSize: "clamp(64px, 12vw, 140px)", color: COULEURS.foreground }}
                    >
                        {words.map((word, i) => (
                            <span key={i} className="inline-block overflow-hidden mr-4 last:mr-0">
                                <motion.span
                                    ...
                                    style={{ color: word === "VELESKY" ? COULEURS.accent : "inherit" }}
                                >
                                    {word === "VELESKY" ? "VELESKY" : word}
                                    {word === "VELESKY" ? " ?" : ""}
                                </motion.span>
                                {word === "EST" && <br className="md:hidden" />}
                            </span>
                        ))}
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
                    ...
                    <div className="lg:col-span-5 relative group">
                        ...
                        <motion.div
                            ...
                            className="absolute -bottom-6 -right-6 md:right-0 px-6 py-4 rounded-2xl flex items-center gap-3 shadow-2xl backdrop-blur-xl"
                            style={{
                                backgroundColor: "rgba(15, 15, 15, 0.8)",
                                border: `1px solid ${COULEURS.borderSubtle}`
                            }}
                        >
                            <span className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: COULEURS.accent }} />
                            <span className="font-dm-mono text-xs tracking-wider" style={{ color: COULEURS.foreground }}>
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-12 pt-4">
                        <div className="flex flex-col gap-8">
                            ...
                            >
                                Je suis <span style={{ color: COULEURS.accent }}>{VELESKY.nom.split(' ').pop()}</span>, développeur basé en Côte d&apos;Ivoire. Je fusionne <span className="italic">ingénierie</span> et <span className="italic">esthétique</span> pour créer des solutions numériques d&apos;exception.
                            </motion.p>
                            ...
                            >
                                <p className="font-dm-mono text-base md:text-lg leading-relaxed text-neutral-400">
                                    Spécialisé dans l&apos;écosystème <span className="text-white">Flutter</span> pour le mobile et <span className="text-white">Next.js</span> pour le web, j&apos;accorde une importance capitale à l&apos;expérience utilisateur et aux performances offline.
                                </p>
                                <p className="font-dm-mono text-base md:text-lg leading-relaxed text-neutral-500 italic">
                                    &quot;Vibe coder&quot; par passion, mon code est rythmé par la recherche de la perfection visuelle et la robustesse architecturale.
                                </p>
                            </motion.div>
                        </div>

                        {/* Bloc Statistiques (Counter Animation) */}
                        <div className="grid grid-cols-3 gap-6 md:gap-10 pt-8 border-t border-white/5">
                            {STATS.map((stat, i) => (
                                <motion.div
                                    key={stat.label}
                                ...
                                >
                                    <Counter
                                        value={stat.valeur}
                                        className="font-bebas text-4xl md:text-6xl leading-none"
